...
class Material(models.Model):
    ...
    chemical_structure_image = models.BinaryField(blank=True, null=True)
    chemical_structure_image_content_type = models.CharField(max_length=50, blank=True, null=True)
